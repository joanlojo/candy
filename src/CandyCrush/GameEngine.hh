...
namespace GameEngine {
	...
	void LoadMedia(void) {
		...
		R.LoadTexture<ObjectID::BG_01>("gfx/fondoAlternativo.jpg");
		R.LoadTexture<ObjectID::BG_02>("gfx/play.png");
		R.LoadTexture<ObjectID::BG_03>("gfx/exit.png");
		R.LoadTexture<ObjectID::BG_04>("gfx/olaf.png");
		R.LoadTexture<ObjectID::BG_05>("gfx/bala.png");
	}
	//! Adds the game scenes into the Scene Manager and decides which is the first screen
	void AddScenes(void) {
		SM.AddScene<GameScene>(); //instanciando a Scene Manager añader una nueva escena
		SM.AddScene<OtherScene>();
